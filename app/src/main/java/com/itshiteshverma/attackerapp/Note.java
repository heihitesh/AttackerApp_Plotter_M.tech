...
public class Note {
    ...
    public static final String COMMAND_REPETITION = "COMMAND_REPETITION";
    ...
    public static final String CREATE_TABLE_COMMANDS = "create table " + COMMAND_TABLE +
            " (" + COMMAND_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COMMAND_ACTION +
            " TEXT," + COMMAND_REPETITION + " INTEGER )";
